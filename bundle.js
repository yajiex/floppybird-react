...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sound = function () {
	    ...
	    _createClass(Sound, [{
	        key: 'playSoundJump',
	        value: function playSoundJump() {
	            this.soundJump.stop();
	            this.soundJump.play();
	        }
	    }, {
	        key: 'playSoundScore',
	        value: function playSoundScore() {
	            this.soundScore.stop();
	            this.soundScore.play();
	        }
	    }, {
	        key: 'playSoundHit',
	        value: function playSoundHit(callback) {
	            this.soundHit.play().bindOnce("ended", callback);
	        }
	    }, {
	        key: 'playSoundDie',
	        value: function playSoundDie(callback) {
	            this.soundDie.play().bindOnce("ended", callback);
	        }
	    }, {
	        key: 'playSoundSwoosh',
	        value: function playSoundSwoosh() {
	...
	var Ceiling = function (_React$Component) {
	    _inherits(Ceiling, _React$Component);

	    function Ceiling() {
	        _classCallCheck(this, Ceiling);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Ceiling).apply(this, arguments));
	    }

	    _createClass(Ceiling, [{
	        key: 'getTopHeight',
	        value: function getTopHeight() {
	            return $(this.refs.ceiling).offset().top + $(this.refs.ceiling).height();
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { ref: 'ceiling', id: 'ceiling', style: {
	...
	var Land = function (_React$Component2) {
	    _inherits(Land, _React$Component2);

	    function Land() {
	        _classCallCheck(this, Land);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Land).apply(this, arguments));
	    }
	    ...
	    _createClass(Land, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { ref: 'land', id: 'land', style: { animationPlayState: this.props.animationPlayState, WebkitAnimationPlayState: this.props.animationPlayState } },
	...
	var BigScore = function BigScore(props) {
	    var digits = props.erase ? [] : props.score.toString().split('');
	    return _react2.default.createElement(
	        'div',
	        { id: 'bigscore' },
	        digits.map(function (digit, index) {
	            return _react2.default.createElement('img', { key: "digit" + index, src: 'assets/font_big_' + digit + '.png', alt: digit });
	        })
	    );
	};

	var Splash = function (_React$Component3) {
	    _inherits(Splash, _React$Component3);
	    ...
	    _createClass(Splash, [{
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { id: 'splash', ref: 'splash' });
	        }
	    }]);
	...
	var Player = function (_React$Component4) {
	    ...
	    _createClass(Player, [{
	        ...
	        key: 'dropToFloor',
	        value: function dropToFloor(flyAreaHeight) {
	        ...
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement('div', { ref: 'player', id: 'player', className: 'bird', style: {
	                    x: 0,
	                    y: this.props.y,
	                    top: this.props.top,
	...
	var Medal = function (_React$Component5) {
	    _inherits(Medal, _React$Component5);

	    function Medal() {
	        _classCallCheck(this, Medal);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(Medal).apply(this, arguments));
	    }
	    ...
	    _createClass(Medal, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { id: 'medal', ref: 'medal', style: { scale: this.props.scale, opacity: this.props.opacity } },
	                this.props.medal === null ? "" : _react2.default.createElement('img', { src: "assets/medal_" + this.props.medal + ".png", alt: "'" + this.props.medal + "'" })
	            );
	        }
	    }]);
	...
	var CurrentScore = function CurrentScore(props) {
	    ...
	    return _react2.default.createElement(
	        ...
	        { id: 'currentscore' },
	        digits.map(function (digit, index) {
	            return _react2.default.createElement('img', { key: "digit" + index, src: 'assets/font_small_' + digit + '.png', alt: digit });
	        })
	    );
	};
	...
	var Replay = function (_React$Component6) {
	    _inherits(Replay, _React$Component6);

	    function Replay(props) {
	        _classCallCheck(this, Replay);

	        var _this6 = _possibleConstructorReturn(this, Object.getPrototypeOf(Replay).call(this, props));

	        _this6.replayclickable = props.replayclickable;
	        return _this6;
	    }
	    ...
	    _createClass(Replay, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { id: 'replay', ref: 'replay', style: { y: this.props.y, opacity: this.props.opacity }, onClick: this.handleClick.bind(this) },
	                _react2.default.createElement('img', { src: 'assets/replay.png', alt: 'replay' })
	            );
	        }
	    }]);
	...
	var ScoreBoard = function (_React$Component7) {
	    _inherits(ScoreBoard, _React$Component7);

	    function ScoreBoard(props) {
	        _classCallCheck(this, ScoreBoard);

	        var _this7 = _possibleConstructorReturn(this, Object.getPrototypeOf(ScoreBoard).call(this, props));

	        _this7.state = {
	            display: _this7.props.display
	        };
	        return _this7;
	    }
	    ...
	    _createClass(ScoreBoard, [{
	        ...
	        key: 'triggerReplayClick',
	        value: function triggerReplayClick() {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { id: 'scoreboard', ref: 'scoreBoard', style: { display: this.state.display, y: this.props.y, opacity: this.props.opacity } },
	                _react2.default.createElement(Medal, { ref: 'medal', medal: this.props.medal, scale: this.props.medalScale, opacity: this.props.medalOpacity }),
	                _react2.default.createElement(CurrentScore, { score: this.props.score }),
	                _react2.default.createElement(HighScore, { highScore: this.props.highScore }),
	                _react2.default.createElement(Replay, { ref: 'replay',
	...
	var Pipe = function (_React$Component8) {
	    _inherits(Pipe, _React$Component8);
	    ...
	    _createClass(Pipe, [{
	        key: 'getPositionLeft',
	        value: function getPositionLeft() {
	            return $(this.refs.pipe).position().left;
	        }
	    }, {
	        key: 'getPipeUpper',
	        value: function getPipeUpper() {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'pipe', ref: 'pipe', style: { animationPlayState: this.props.animationPlayState, WebkitAnimationPlayState: this.props.animationPlayState } },
	                _react2.default.createElement('div', { ref: 'pipeUpper', className: 'pipe_upper', style: { height: this.props.topheight } }),
	                _react2.default.createElement('div', { className: 'pipe_lower', style: { height: this.props.bottomheight } })
	            );
	        }
	    }]);
	...
	var Pipes = function (_React$Component9) {
	    _inherits(Pipes, _React$Component9);

	    function Pipes(props) {
	        _classCallCheck(this, Pipes);

	        var _this9 = _possibleConstructorReturn(this, Object.getPrototypeOf(Pipes).call(this, props));
	    ...
	    _createClass(Pipes, [{
	        ...
	        key: 'getNextPipeUpper',
	        value: function getNextPipeUpper() {
	            return this.refs[this.pipes[0].refName].getPipeUpper();
	        }
	    }, {
	        key: 'initialPipesCount',
	        value: function initialPipesCount() {
	            this.pipes = [];
	            this.setState({ pipes: [] });
	        }
	    }, {
	        key: 'getPipesCount',
	        value: function getPipesCount() {
	            return this.pipes.length;
	        }
	    }, {
	        key: 'slicePipes',
	        value: function slicePipes() {
	            this.pipes.splice(0, 1);
	        }
	    }, {
	        key: 'updatePipes',
	        value: function updatePipes(newPipeProp) {
	        ...
	        value: function render() {
	            ...
	            for (var i = 0; i < this.state.pipes.length; i++) {
	                pipesComponents.push(_react2.default.createElement(Pipe, { ref: this.state.pipes[i].refName, key: this.state.pipes[i].refName, topheight: this.state.pipes[i].topheight, bottomheight: this.state.pipes[i].bottomheight, animationPlayState: this.props.animationPlayState }));
	            }
	            return _react2.default.createElement(
	                'div',
	                null,
	...
	var FlyArea = function (_React$Component10) {
	    _inherits(FlyArea, _React$Component10);

	    function FlyArea(props) {
	        _classCallCheck(this, FlyArea);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(FlyArea).call(this, props));
	    }

	    _createClass(FlyArea, [{
	        key: 'getFlyAreaHeight',
	        value: function getFlyAreaHeight() {
	        ...
	        key: 'getCeilingTopHeight',
	        value: function getCeilingTopHeight() {
	            return this.refs.ceiling.getTopHeight();
	        }
	    }, {
	        key: 'handleScoreBoardClick',
	        value: function handleScoreBoardClick() {
	            this.props.onClick();
	        }
	    }, {
	        key: 'showSplash',
	        ...
	        key: 'getPlayerBoundingClientRect',
	        value: function getPlayerBoundingClientRect() {
	            return this.refs.player.getBoundingClientRect();
	        }
	    }, {
	        key: 'dropPlayerToFloor',
	        value: function dropPlayerToFloor() {
	            this.refs.player.dropToFloor(this.getFlyAreaHeight());
	        }
	    }, {
	        key: 'showScoreBoard',
	        value: function showScoreBoard(callback) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { id: 'flyarea', ref: 'flyArea' },
	                _react2.default.createElement(Ceiling, { ref: 'ceiling', animationPlayState: this.props.animationPlayState }),
	                _react2.default.createElement(Player, { ref: 'player',
	                    top: this.props.playerTop,
	                    y: this.props.playerY,
	                    rotation: this.props.playerRotation,
	                    animationPlayState: this.props.animationPlayState,
	                    WebkitAnimationPlayState: this.props.animationPlayState }),
	                _react2.default.createElement(BigScore, { erase: this.props.bigScoreErase,
	                    score: this.props.score }),
	                _react2.default.createElement(Splash, { ref: 'splash' }),
	                _react2.default.createElement(ScoreBoard, { ref: 'scoreBoard',
	                ...
	                _react2.default.createElement(Pipes, { ref: 'pipes', animationPlayState: this.props.animationPlayState, flyAreaHeight: this.getFlyAreaHeight() })
	            );
	        }
	    }]);
	...
	var GameScreen = function (_React$Component11) {
	    _inherits(GameScreen, _React$Component11);

	    function GameScreen(props) {
	        _classCallCheck(this, GameScreen);

	        var _this11 = _possibleConstructorReturn(this, Object.getPrototypeOf(GameScreen).call(this, props));

	        _this11.states = Object.freeze({
	            SplashScreen: 0,
	            GameScreen: 1,
	            ScoreScreen: 2
	        });
	        _this11.pipeHeight = 200;
	        _this11.pipeWidth = 52;
	        _this11.replayclickable = false;
	        _this11.sound = new Sound();

	        var savedScore = _this11.getCookie("highScore");
	        if (savedScore !== "") {
	            // TODO: Maybe bug
	            _this11.state = {
	        ...
	        _this11.state = {
	            currentState: _this11.states.SplashScreen,
	            playerVelocity: 0,
	            playerTop: 180,
	            playerRotation: 0,
	            playerY: 0,
	    ...
	    _createClass(GameScreen, [{
	        ...
	        key: 'setSmallScore',
	        value: function setSmallScore() {}
	    }, {
	        key: 'setMedal',
	        value: function setMedal() {
	        ...
	        key: 'setBigScore',
	        value: function setBigScore(erase) {
	        ...
	        key: 'handleFlyAreaClick',
	        value: function handleFlyAreaClick() {
	            this.sound.playSoundSwoosh();
	            this.showSplash();
	        }
	    }, {
	        key: 'hideSplashAnimation',
	        value: function hideSplashAnimation() {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { id: 'sky', style: { animationPlayState: this.state.animationPlayState, WebkitAnimationPlayState: this.state.animationPlayState } },
	                    _react2.default.createElement(FlyArea, { ref: 'flyArea',
	                ...
	                _react2.default.createElement(Land, { ref: 'land', animationPlayState: this.state.animationPlayState })
	            );
	        }
	    }]);
	...
	_reactDom2.default.render(_react2.default.createElement(GameScreen, null), document.getElementById("gamecontainer"));
